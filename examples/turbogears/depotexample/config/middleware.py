# -*- coding: utf-8 -*-
"""WSGI middleware initialization for the depotexample application."""

from depotexample.config.app_cfg import base_config
from depotexample.config.environment import load_environment
